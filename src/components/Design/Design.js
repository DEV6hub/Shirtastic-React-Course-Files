...
class Design extends Component {
  ...
  selectGraphic = graphic => {
    ...
    console.log("the graphic", graphic);
              ...
              <TabContent activeTab={this.state.activeTab}>
                        ...
                        <Col key={index}>
                          <div
                            className={
                              ...
                              classnames({
                                active:
                                  this.props.shirtToEdit.shirtStyle ===
                                  style.image
                              })
                            }
                            onClick={() => {
                              this.selectStyle(style.image);
                            }}
                          >
                            <img
                              className="img-fluid"
                              src={require(`../../images/${this.renderImage(
                                style.image,
                                this.props.shirtToEdit.shirtColor.name
                              )}.jpg`)}
                              alt="shirt style"
                            />
                          </div>
                ...
                <TabPane tabId="2">
                  <ColorPicker
                    ...
                    attribute={"shirt"}
                    selectedColor={this.props.shirtToEdit.shirtColor}
                    title={"Choose a shirt colour"}
                  />
                </TabPane>
                <TabPane tabId="3">
                  <Graphic
                    selectedGraphic={this.props.shirtToEdit.graphic}
                  ...
                  <ColorPicker
                    selectColor={this.selectColor}
                    attribute={"graphic"}
                    selectedColor={this.props.shirtToEdit.graphicColor}
                    title={"Change graphic colour"}
                  />
                </TabPane>
                <TabPane tabId="4">
                  <Text
                    text={this.props.shirtToEdit.text}
                    addShirtText={this.addShirtText}
                    changeTextFont={this.changeTextFont}
                    font={this.props.shirtToEdit.font}
                  />
                  <ColorPicker
                    selectColor={this.selectColor}
                    attribute={"text"}
                    selectedColor={this.props.shirtToEdit.textColor}
          ...
          <Col className="style-config-col">
            <Card className="img-configurator" id="imageRef">
              ...
              <img
                ...
                style={{ display: "none" }}
                src={
                  this.props.shirtToEdit.graphic
                    ? require(`../../images/${this.props.shirtToEdit.graphic}`)
                    : ""
                }
                alt="shirt graphic"
              />
              <div
                ...
                style={{
                  color: this.props.shirtToEdit.textColor.color,
                  fontFamily: this.props.shirtToEdit.font
                }}
              >
                {this.props.shirtToEdit.text}
              </div>
            </Card>
          </Col>
        </Row>
