...
export default class Catalog extends Component {
  ...
  saveShirtDesign = () => {
    ...
    newShirt.image =
      newShirt.shirtStyle + "-" + newShirt.shirtColor.name.toLowerCase();
      ...
      <div>
        <div id="cart" className="sidenav-cart" ref="cart">
          ...
          <Cart
            ...
            shirtsInCart={this.state.shirtsInCart}
        ...
        <div
          className={
            !this.state.showConfirmation
              ? "sidenav-payment"
              : "sidenav-confirmation"
          }
          ref="payment"
        >
          {!this.state.showConfirmation ? (
            <Payment checkout={this.checkout} />
          ) : (
            <Confirmation goToCatalog={this.goToCatalog} />
          )}
        </div>
            ...
            {this.state.openDesign ? (
              <div>
                <input
                  ...
                  type="text"
                  value={this.state.shirtToEdit.name}
                  onChange={this.setShirtTitle}
                />
                <button
                  className="primary-btn nav-btn"
                  onClick={() => {
                    this.saveShirtDesign();
                  }}
                >
                  SAVE DESIGN
                </button>
        ...
        <div>
          ...
          {this.state.openDesign ? (
            ...
            <div>
              {this.props.fetchingShirts ? (
                <h1 style={{ color: "red" }}>FETCHING SHIRTS</h1>
              ) : (
                ""
              )}
              <CatalogTabs
